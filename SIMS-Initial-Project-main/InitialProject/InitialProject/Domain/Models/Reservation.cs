...
namespace InitialProject.Domain.Model {
    public class Reservation : ISerializable
    {
        ...
        public string[] ToCSV()
        {
            string[] csvValues = { Id.ToString(), GuestUserName, AccommodationId.ToString(), DateFrom.ToString(),
                DateTo.ToString(), DaysNumber.ToString(), GuestsNumber.ToString(), GradeStatus };
            return csvValues;
        }
